...
<h1 class= "text-white font-weight-bold p-4">
 Decentralized Fund Management Protocol
    ...
    <p class= "text-white font-weight-bold px-2 ">0x311f0d8782bf7d945519bb7592c76f6c53bd37c3</p>
...
<div class="card-text text-white mt-2">
     ...
     <div class="offer">
       ...
       <h1 class="text-center mt-5 text-white py-3" >ProfitBank Offers you</h1>
          ...
          <div data-aos="fade-up"
     data-aos-duration="3000">
     <div class="card mb-3  text-center card2 h-100  text-white p-3">
       <div class="card-body">
...
Pooling PBANK for pre-qualified projects for a fixed period. Returns are stated by each pool and
          ...
          <div data-aos="fade-up"
     data-aos-duration="3000">
     <div class="card mb-5 text-center card2 h-100  text-white p-3">
       <div class="card-body">
...
<div class="row mt-5">
    ...
    <div class="col-lg col-xs-12 col-sm-12 col-md-6 mb-2">
        ...
        <a href="https://twitter.com/profitbankcoin?s=20" class="ml-4 mt-4">
